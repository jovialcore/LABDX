				...
				<div class="content container-fluid">
							...
							<div class="col-md-12">
								<div class="d-flex align-items-center">
									...
									<ul class="breadcrumb ml-2">
										...
										<li class="breadcrumb-item active">Patients Documents</li>
									</ul>
								</div>
							</div>
						</div>
					...
					<div class="row">
						<div class="col-sm-12">
									...
									<form action="#">
										<div class="form-group row">
											...
											<div class="col-md-10">
												<select class="select">
													...
													<option>Advanced Module</option>
													<option>CCD</option>
													<option>CCDA</option>
													<option>CCR</option>
													<option>Eye Module</option>
												</select>
											</div>
										</div>
										<div class="form-group row">
											<label class="col-form-label col-md-2">Destination Name</label>
											<div class="col-md-10">
										...
										<div class="form-group row">
											...
											<div class="col-md-10">
												...
												<p class="mt-2">NOTE: Uploading files with duplicate names will cause the files to be automatically renamed (for example, file.jpg will become file.1.jpg). Filenames are considered unique per patient, not per category.</p>
											</div>
										</div>
							...
							<div class="card">
								<div class="card-header">
									<h4 class="card-title">View Documments</h4>
								</div>
								<div class="card-body">
									<form action="#">
										<div class="form-group row">
											<label class="col-form-label col-md-2">Document Template</label>
											<div class="col-md-10">
												<select class="select">
										...
										<div class="form-group row mt-4">
											...
											<div class="col-md-10">
												<select class="select">
													<option>-- Open Form Module --</option>
													<option>Advanced Module</option>
													<option>CCD</option>
													<option>CCDA</option>
													<option>CCR</option>
