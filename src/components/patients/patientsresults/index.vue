							...
							<div class="col-md-12">
								<div class="d-flex align-items-center">
									...
									<ul class="breadcrumb ml-2">
										...
										<li class="breadcrumb-item active">Patient Results</li>
									</ul>
								</div>
							</div>
						</div>
										...
										<table class="table mb-0">
											...
											<tbody>
												<tr>
													...
													<td class="text-info">CPT4 - 99202</td>
												</tr>
												<tr>
													<td>5 Dec 2020</td>
													<td>consectetur adipiscing</td>
													...
													<td class="text-info">ICD9 - 296.20</td>
												</tr>
												<tr>
													<td>6 Jan 2020</td>
													<td>consectetur adipiscing</td>
													...
													<td>0hrs 50min</td>
													<td><span class="badge bg-success-light">Approved</span></td>
													<td class="text-info">ICD9 - 125.10</td>
												</tr>
												<tr>
													<td>19 Dec 2020</td>
													<td>consectetur adipiscing</td>
													...
													<td>5hrs 12min</td>
													<td><span class="badge bg-success-light">Approved</span></td>
													<td class="text-info">CPT4 - 4589</td>
												</tr>
												<tr>
													<td>15 Dec 2020</td>
													<td>consectetur adipiscing</td>
													...
													<td class="text-info">ICD9 - 435.60</td>
												</tr>
											</tbody>
										</table>
									</div>
