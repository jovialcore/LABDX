							...
							<div class="col">
								<div class="d-flex align-items-center">
									...
									<ul class="breadcrumb ml-2">
										...
										<li class="breadcrumb-item active">Patients Transactions</li>
									</ul>
								</div>
							</div>
											...
											<tbody>
												<tr>
													...
													<td class="text-right d-flex">
														<router-link to="/invoice" class="btn btn-sm btn-white text-success mr-2 d-flex align-items-center"><i class="fas fa-eye mr-1"></i> View</router-link> 
