											...
											<div class="col-md-6">
												<div class="form-group">
													...
													<select class="select">
														...
														<option value="2">Established Patient</option>
														<option value="3">New Patient</option>
														<option value="4">Health and Behavioral Assessment</option>
													</select>
												</div>
												<div class="form-group">
												...
												<div class="form-group">
													...
													<select class="select">
														<option>Select</option>
														<option value="1">Great Clinic</option>
													</select>
												</div>
												<div class="form-group">
