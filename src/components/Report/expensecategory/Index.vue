						...
						<div class="col-xl-3 col-md-4">
							...
							<div class="widget settings-menu">
								<ul>
									...
									<li class="nav-item">
										<router-link to="/expense-category" class="nav-link active">
							...
							<div class="card">
								<div class="card-header no-border">
									<div class="row">
										...
										<div class="col-auto">
											<a href="javascript:void(0);" class="btn btn-outline-primary btn-sm" data-toggle="modal" data-target="#add_category">Add New Category</a>
										</div>
									</div>
								</div>
								<div class="card-body">
										...
										<table class="table custom-table mb-0">
											...
											<tbody>
												<tr>
													...
													<td class="text-right">
														<a href="#" data-toggle="modal" data-target="#edit_category" class="btn btn-sm btn-white text-success mr-2"><i class="far fa-edit mr-1"></i> Edit</a> 
														<a href="#" data-toggle="modal" data-target="#delete_category" class="btn btn-sm btn-white text-danger mr-2"><i class="far fa-trash-alt mr-1"></i>Delete</a>
													</td>
												</tr>
												<tr>
													<td>Sales</td>
