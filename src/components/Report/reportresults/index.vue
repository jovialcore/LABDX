								...
								<div class="card-body">
									<div class="table-responsive">
										<table class="table mb-0">
											...
											<tbody>
												<tr>
													<td>Processing Patient Reminders</td>
													<td>2020-12-29 </td>
													<td>15:32:52</td>
													<td>Complete (Processing Time: 32 Minutes)</td>
												</tr>
												<tr>
													<td>Processing and Sending Patient Reminders</td>
													<td>2020-12-29 </td>
													<td>15:33:05</td>
													<td>Complete (Processing Time: 22 Minutes)</td>
												</tr>
												<tr>
													<td>Standard Measures (Passive Alerts)</td>
													<td>2020-12-29 </td>
													<td>15:36:16</td>
													<td>Complete (Processing Time: 52 Minutes)</td>
												</tr>
												<tr>
													<td>Clinical Quality Measures (CQM)</td>
													<td>2020-12-30 </td>
													<td>05:25:46</td>
													<td>Complete (Processing Time: 45 Minutes)</td>
												</tr>
											</tbody>
										</table>
									</div>
